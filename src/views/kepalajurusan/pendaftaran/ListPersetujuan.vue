...
const getData = async () => {
    try {
        const response = await Api.get("kaprodi/pendaftaran/list/persetujuan");
    ...
    <div class="bg-white p-3 shadow-sm rounded-sm">
        ...
        <div class="bg-white p-3 shadow-sm rounded-sm">
            <div class="flex items-center space-x-2 font-semibold text-gray-900 leading-8">
                ...
                <span class="tracking-wide">Data Persetujuan</span>
            </div>
    ...
    perPageDropdown: [10, 20, 50],
                        ...
                        <template #table-row="props">
                            <span v-if="props.column.field == 'actions'">
                                <div class="text-sm font-medium text-center flex justify-center gap-1">
                                    <label for="my-modal-detail" data-tip="Proses Persetujuan"
                                        class="btn modal-button btn-sm" @click="onCickModal(props.row.siswa_id)">
                                        Detail
                                    </label>
                                </div>
                            </span>
        ...
        <label class="modal-box relative w-full lg:w-8/12 max-w-5xl" for="">
                ...
                <div class="w-full md:w-6/12">
                    <div class="card-actions lg:px-6 py-2">
                        ...
                        <a target="_blank" :href="dataModal.file">
                            <button data-tip="Download file Balasan" class="tooltip btn btn-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="py-4 px-4">
                            ...
                            <textarea v-model="dataDetail.keterangan" class="textarea textarea-error w-96 h-32"
                                placeholder="Keterangan jika ditolak "></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-wrap justify-center">
                <div class="card w-96 bg-base-100 shadow-sm">
                    <div class="card-body">
                        <div class="card-actions justify-end">
                            <button class="btn btn-primary" @click="doSubmitPersetujuan('Disetujui')">
                                Setujui
                            </button>
                            <button class="btn btn-danger" @click="doSubmitPersetujuan('Ditolak')">
                                Tolak
                            </button>
                        </div>
                    </div>
