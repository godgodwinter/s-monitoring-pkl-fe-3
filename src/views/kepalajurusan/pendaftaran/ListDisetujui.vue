...
const getData = async () => {
    try {
        const response = await Api.get("kaprodi/pendaftaran/list/disetujui");
                    ...
                    <div class="w-full mx-0">
                        <div class="bg-white rounded-lg p-0 sm:p-6 xl:p-0">
                            <div class="grid grid-cols-1 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="name" class="text-sm font-medium text-gray-900 block mb-2">Guru
                        ...
                        required /> -->
                                    <v-select class="py-2 px-3 w-72 mx-auto md:mx-0" :options="pilihPembimbingSekolah"
                                        v-model="dataForm.pembimbingsekolah_id"
                        ...
                        <template #table-row="props">
                            <span v-if="props.column.field == 'actions'">
                                <div class="text-sm font-medium text-center flex justify-center">
                                    ...
                                    </router-link> <button class="btn btn-sm btn-warning tooltip"
                                        data-tip="Edit Pembimbing Sekolah"
