...
storeAdmin.setPagesActive("mastering-tempatpkl");
                ...
                <Form v-slot="{ errors }" @submit="onSubmit" v-if="data">
                    <div class="pt-0 px-0">
                        <div class="w-full mx-0">
                            <div class="bg-white rounded-lg p-0 sm:p-6 xl:p-0">
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="name"
                                            class="text-sm font-medium text-gray-900 block mb-2">Telp</label>
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="name"
                                            class="text-sm font-medium text-gray-900 block mb-2">Penanggung Jawab /
                                            Pembimbing
                                            Lapangan</label>
                      ...
                      required /> -->
                                        ...
                                        <v-select class="py-2 px-3 w-72 mx-auto md:mx-0"
                                            :options="pilihPembimbingLapangan" v-model="inputPilihPembimbingLapangan"
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="name"
                                            class="text-sm font-medium text-gray-900 block mb-2">Kuota</label>
                                        <Field v-model="dataDetail.kuota" :rules="validateData" type="number"
                                            name="kuota" ref="kuota"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                            required />
                                        <div class="text-xs text-red-600 mt-1">
                                            {{ errors.kuota }}
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="name" class="text-sm font-medium text-gray-900 block mb-2">Tanggal
                                            Mulai PKL</label>
                                        <Datepicker v-model="dataDetail.tgl_mulai" format="yyyy/MM/dd"
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="name" class="text-sm font-medium text-gray-900 block mb-2">Tanggal
                                            Selesai PKL</label>
                                        <Datepicker v-model="dataDetail.tgl_selesai" format="yyyy/MM/dd"
                                            value-format="yyyy-MM-dd">
                                            <template #calendar-header="{ index, day }">
                                                <div :class="index === 5 || index === 6 ? 'red-color' : ''">
                                                    {{ day }}
