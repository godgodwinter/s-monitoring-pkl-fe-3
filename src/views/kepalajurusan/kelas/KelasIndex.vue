...
const getDataJurusan = async () => {
    ...
    try {
        ...
        dataJurusan.value.forEach(element => {
            ...
            // console.log('====================================');
            // console.log(jurusan.value.nama, temp.label, jurusan.value.nama == temp.label);
            // console.log('====================================');
            if (jurusan.value.nama == temp.label) {
...
setTimeout(() => {
    // console.log('====================================');
    // console.log(jurusan.value.nama);
    // console.log('====================================');
    ...
    perPageDropdown: [10, 20, 50],
                    ...
                    <template #table-row="props">
                        ...
                        <span v-else-if="props.column.field == 'nilai'">
                            <button class="btn btn-sm btn-info" @click="doGoNilai(props.row.id)">Detail</button>
                        </span>
                        <span v-else>
            ...
            <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8">
                ...
                <Form v-slot="{ errors }" @submit="onSubmit" v-if="data">
                    <div class="pt-0 px-0">
                            ...
                            <div class="bg-white rounded-lg p-0 sm:p-6 xl:p-0">
                                <div class="grid grid-cols-1 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="name"
                                            class="text-sm font-medium text-gray-900 block mb-2">Tingkatan</label>
                                        <Field v-model="dataDetail.tingkatan" :rules="validateData" type="text"
                                            name="tingkatan" ref="tingkatan"
                      ...
                      class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                      required /> -->
                                        <v-select class="py-2 px-3 w-72 mx-auto md:mx-0" :options="pilihJurusan"
                                            v-model="inputPilihJurusan" v-bind:class="{ disabled: false }"></v-select>
                                ...
                                <div class="grid grid-cols-1 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="name"
                                            class="text-sm font-medium text-gray-900 block mb-2">Suffix</label>
                                        <Field v-model="dataDetail.suffix" :rules="validateData" type="text"
                                            name="suffix" ref="suffix"
                                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                            required />
                ...
                <div class="pt-0 px-0">
                    <div class="w-full mx-0">
                        <div class="bg-white rounded-lg p-0 sm:p-6 xl:p-0">
                            <div class="grid grid-cols-1 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="name" class="text-sm font-medium text-gray-900 block mb-2">TOTAL
                                        TAGIHAN</label>
                                    <input v-model="dataFormTagihan.total_tagihan" type="text" name="total_tagihan"
                                        ref="total_tagihan"
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                                        required />
                                </div>
